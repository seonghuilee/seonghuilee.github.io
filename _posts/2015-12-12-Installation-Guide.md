...
The same process follows from above for adding new posts and content to your site. For a full guide on using Lagrange, check out the [Working With Jekyll]({{ site.baseurl }}{% post_url 2015-11-11-Working-With-Jekyll %}) post.
